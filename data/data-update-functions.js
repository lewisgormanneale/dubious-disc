...
async function addExtraData() {
    for (let i = 0; i < dex.length; i++) {
        ...
        dex[i].shiny_sprite = `../images/sprites/pokemon/versions/generation-iv/diamond-pearl/shiny/${dex[i].national_dex_id}.png`
        ...
        if (dex[i].has_gender_differences === true) {
            dex[i].female_sprite = `../images/sprites/pokemon/versions/generation-iv/diamond-pearl/female/${dex[i].national_dex_id}.png`
