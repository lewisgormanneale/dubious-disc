...
describe('TypeBackgroundGeneratorPipe', () => {
  ...
  it('should return the first type color when no types are passed in', () => {
    ...
    expect(result).toEqual(AllPokemonTypeValues[0].type_color);
  });
  ...
  it('should return the correct type color for a single type', () => {
    ...
    expect(result).toEqual(AllPokemonTypeValues[typeNumber1].type_color);
  });
  ...
  it('should return the correct gradient for two types', () => {
    ...
    const expectedColor = `linear-gradient(to bottom right, ${AllPokemonTypeValues[typeNumber1ID].darker_type_color}, ${AllPokemonTypeValues[typeNumber2ID].type_color})`;
